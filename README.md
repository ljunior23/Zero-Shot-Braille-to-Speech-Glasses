...
- ❌ No 3D-printed sensors
- ❌ No Arduino/ESP32
- ❌ No cloud GPU credits
- ❌ No special hardware

**Uses only what you have:**
- ✅ Laptop webcam (30fps finger tracking)
- ✅ Smartphone IMU (200Hz accelerometer)
- ✅ Free TTS (Google Translate API)
- ✅ Free GPU (Google Colab)
- ✅ Free text (Project Gutenberg)



**Built with ❤️ for innovation under constraints**
